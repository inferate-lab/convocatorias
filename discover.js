...
- Cámara de Comercio de Bogotá — página de convocatorias de cooperación financiera no reembolsable (ccb.org.co): esta página es un ÍNDICE de nombres de convocatorias, no la fuente primaria de cada una (el detalle completo está en un acordeón interactivo que no se puede leer de forma confiable). Para cada nombre de convocatoria que veas ahí y que no esté ya registrada en el sistema, BUSCA esa convocatoria por su nombre exacto para encontrar la página real del donante/cooperante (ej. "Henri Boulard Award 2026" → busca hasta encontrar la página de la Biocodex Microbiota Foundation), y extrae los datos completos (fecha límite, monto, elegibilidad, enlace de postulación) de esa fuente primaria, no de CCB
- RACI (raci.org.ar/category/entradapdf) — archivo histórico de convocatorias en español desde 2017; revisa solo las páginas más recientes y descarta cualquier cosa con fecha de cierre ya vencida o que sea una beca individual (no institucional)
- gpiw.net — su robots.txt prohíbe el acceso automatizado directo; búscalo por nombre/tema en el motor de búsqueda, nunca lo rastrees ni lo abras directamente
- Revisa también convocatorias vigentes (con fecha de cierre real, no archivadas) en estas plataformas agregadoras internacionales: Devex Funding (devex.com/funding), ReliefWeb Funding (reliefweb.int/funding), Candid / Philanthropy News Digest RFPs (philanthropynewsdigest.org/rfps), GrantStation (grantstation.com), GrantWatch (grantwatch.com), Terra Viva Grants Directory (terravivagrants.org — enfocado en agricultura/ambiente, relevante), FundsForNGOs (www2.fundsforngos.org), ProposalsForNGOs (proposalsforngos.com), UN Global Marketplace/UNGM (ungm.org), Portal de Fondos y Licitaciones de la UE (ec.europa.eu/info/funding-tenders/opportunities/portal), EuropeAid/INTPA (internationalpartnerships.ec.europa.eu/funding_en), Banco Mundial - Procurement (worldbank.org/en/projects-operations/procurement), BID - Procurement (iadb.org/en/projects/procurement, especialmente relevante por ser el banco de desarrollo de América Latina), Grants.gov (grants.gov, para oportunidades de agencias de EE.UU. abiertas a socios internacionales). No repitas oportunidades ya registradas en el sistema. Ignora cualquier resultado con fecha de cierre ya vencida.
